...
(
    ...
    -- with varbyte(64000) + insert into data_receipts select * from apg.data_receipts I have:
    -- psycopg2.errors.DatatypeMismatch: column "data" is of type binary varying but expression is of type character varying
